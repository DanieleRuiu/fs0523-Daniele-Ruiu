...
function somma1(number1) { number1 ((acc,current) => acc + current ,0);
  return somma1;
}
  let risultato = somma1(number1);
  console.log(risultato);*/
...
*/ let numeri1 = [1,2,3,4,5,6];
        ...
        let numeriX2 = numeri.map(n => n * 2);

        console.log(numeri1, numeriX2);
...
*/let frase = [ 'Argo', 'Cora',]
let lunghezze = frase.map(items => items.length);
...
*/ let allTitle = Title.map (function(element)){return }
